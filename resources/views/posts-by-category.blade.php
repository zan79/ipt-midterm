...
<div class="card col-md-10 mx-auto bs br my-3 pt-2 bg-primary">
  <h1 class="card-title ms-3 text-light text-center">{{$category->category}} Posts</h1>
</div>
  ...
  <div class="col-md-4 offset-1">
    <div class="card bs br my-3">
      <div class="card-body">
        ...
        <h1 class="text-center fw-bold">{{$category->category}}</h1>
        <hr>
        <h5 class="text-center">🚩 {{$category->remarks}}</h5>
